...
def generate(
    ...
    **kwargs,
    ...
    # read inputs
    prompts, qids, categories, langs, metas = inputs_reader(input_pth, model_config, prompt)    
    
    texts = [] # extended as iteration goes. Extension happens in utils/get_model_outputs().

    n_iters = len(prompts)//batch_size + 1
